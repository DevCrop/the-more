                                ...
                                <div class="no-board-view-btn">
                                    ...
                                    <div id="tooltip" role="tooltip">
                                        <div class="f fd-c no-gap-xs">
                                            ...
                                            <div class="txt f fd-c no-gap-3xs">
                                                <h4 class="--fw-semibold no-clr-text-black no-body-lg ">
                                                    오페라글라스란?
                                                </h4>
                                                <p class="--fw-regular no-clr-text-black ">
